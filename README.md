...
# 📖 Front End Test <a name="about-project"></a>

> This is a Front End challenge project. I built a simple website following Figma guidlines.
...
- **A landing page with four sections**
...
```sh
  cd my-folder
  git https://github.com/frank1738/Front-End-Test-V2.git
```
